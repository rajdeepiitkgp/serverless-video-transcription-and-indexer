...
import { UploadsProvider } from '@/lib/uploads/uploads-provider';
import { VideosLiveProvider } from '@/lib/videos/videos-live';
  ...
  return (
    ...
    >
      <body className="flex min-h-dvh flex-col">
        <ThemeProvider>
          {/* VideosLive outside Uploads: finished uploads poke the shared poller. */}
          <VideosLiveProvider>
            <UploadsProvider>
              <a
                href="#main"
